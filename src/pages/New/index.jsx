        ...
        <Content>
          ...
          <Form>
            ...
            <InputWrapper>
              ...
              <Input label="name" title="Nome do prato" type="text" placeholder="Ex.: Salada Ceasar" onChange={(e) => setTitle(e.target.value)}/>
              <Input label="category" title="Categoria" type="text" placeholder="Pratos principais" onChange={(e) => setCategory(e.target.value)}/>
            </InputWrapper>
